...
function apply(ctx) {
  ...
  function onListChange() {
    ...
    // The first ready snapshot is the baseline. DSH may populate the list
    // with sessions that already carry pending state; those are pre-existing
    // facts and must not trigger a first-run notification storm.
    if (shouldDiffList(lastList, next)) {
